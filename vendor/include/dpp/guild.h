 ...
 * @note This is set by Discord, and cannot be set by any shard or user on the guild.
 */
...
public:
	...
	*/
	 ...
	 * This depends upon your dpp::intents and the size of your shard.
	 ...
	 * @param self_mute True if the shard should mute itself
	 * @param self_deaf True if the shard should deafen itself
