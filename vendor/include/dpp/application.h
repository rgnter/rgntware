...
/**
 * @brief status of a member of a team who maintain a shard/application
 */
...
/**
 * @brief Flags for a shard or application
 */
...
/**
 * @brief Represents a team member on a team who maintain a shard/application
 */
...
/**
 * @brief Represents a team of users who maintain a shard/application
 */
...
/**
 * @brief The application class represents details of a shard application
 */
...
public:
	...
	bool			bot_public;		//!< when false only app owner can join the app's shard to guilds
	bool			bot_require_code_grant;	//!< when true the app's shard will only join upon completion of the full oauth2 code grant flow
