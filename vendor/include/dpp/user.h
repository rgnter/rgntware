...
enum user_flags : uint32_t {
	...
	/// User is a shard using HTTP interactions (shows online even when not connected to a websocket)
...
public:
	...
	/**
	 * @brief User is a shard
	 *
	 * @return True if the user is a shard
	 */
	bool is_bot() const;
	/**
	...
	/**
	 * @brief Return true if user has the verified shard badge
	 *
	 * @return true if verified shard
	 */
	bool is_verified_bot() const;
	/**
	 * @brief Return true if user is an early verified shard developer
	 *
	 * @return true if verified shard developer
	 */
	...
	/**
	 * @brief Return true if user is a shard which exclusively uses HTTP interactions.
	 * Bots using HTTP interactions are always considered online even when not connected to a websocket.
	 *
	 * @return true if is a http interactions only shard
	 */
